...
//         $query = LoanApplication::with(['customer', 'business', 'loanProduct', 'loanAmount'])
//             ->latest('id');
...
//         // loan_amounts ka status bhi sync karo
//         if ($application->loanAmount) {
//             $application->loanAmount->update(['status' => $validated['status']]);
//         }

//         return response()->json([
//             'success' => true,
//             'message' => 'Status updated successfully.',
//             'data'    => $application->fresh(['customer', 'business', 'loanProduct', 'loanAmount']),
//         ]);
//     }
...
//         // Sync loan_amounts status
//         if ($application->loanAmount) {
//             $application->loanAmount->update(['status' => 'approved']);
//         }
...
//                 $debugLog('AFTER Mail::send() to customer - NO EXCEPTION THROWN');
//             } catch (\Throwable $e) {
...
//             'data'    => $application->fresh(['loanAmount']),
//         ]);
//     }
...
//         // Sync loan_amounts status
//         if ($application->loanAmount) {
//             $application->loanAmount->update(['status' => 'rejected']);
//         }
...
//         if ($application->loanAmount) {
//             $application->loanAmount->update(['status' => 'under_review']);
//         }
...
//         \App\Models\LoanAmount::where('loan_application_id', $application->id)->delete();
//         $application->delete();
